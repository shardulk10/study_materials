...
class Staticpages extends BaseController
{
    ...
    {
        parent::__construct();
        $this->page_types = array('1'=>'About Us', '2'=>'Faqs','3'=>'Static Page', '4'=>'Static Content');
        ...
        //die('Hello');
           ...
           // $this->form_validation->set_rules('heading','Email','trim|required|max_length[28]');
            ...
            else
            {
                ...
                $mainpage = $this->security->xss_clean($this->input->post('mainpage'));


                $slideInfo = array();
                $slideInfo['page_title'] = $profile_name;
                $slideInfo['menu_name'] = $menu_name;
