<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Testimonial
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateTestimonials/<?php echo $slideInfo->id ?>" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Testimonee Name</label>
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->name)) {echo ($slideInfo->name);}  ?>" id="profile_name" name="profile_name" maxlength="128">
                                    </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Testimonee Image</label>
                                        <input type="file" class="form-control" value="" id="profile_image" name="profile_image">
                                        <?php if(!empty($slideInfo->image_path)) { ?>
                                          <img src="<?php echo $slideInfo->image_path ?>" width="120" height="120" />
                                        <?php } ?>
                                    </div>                                    
                                </div>
                              </div> 
                               <div class="row">  
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="short_description" name="short_description"><?php if(isset($slideInfo->intro)) {echo nl2br($slideInfo->intro);}  ?></textarea>
                                    </div>
                                </div>
                               </div> 
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->video_url)) {echo ($slideInfo->video_url);}  ?>" id="youtube_url" name="youtube_url">
                                    </div>
