    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>MVL</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Maxima V. LLP</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo !empty($name) ? $name : ""; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>manageBrands">
                <i class="fa fa-ticket"></i>
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>manageOneliner">
                <i class="fa fa-ticket"></i>
                <span>Manage Oneliner</span>
              </a>
            </li>

            <li class="treeview">
              <a href="<?php echo base_url(); ?>manageEmailsubscription">
                <i class="fa fa-ticket"></i>
                <span>Manage Email Subscription</span>
              </a>
            </li>

            <?php

            if(!empty($role) && $role == ROLE_ADMIN)
            {
            ?>
            <li class="treeview">
