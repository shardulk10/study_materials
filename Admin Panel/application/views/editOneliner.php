...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Oneliner
        <small>Add / Edit Oneliner</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Oneliner Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateOneliner/<?php echo $slideInfo->id ?>" method="post" role="form" <?php if($this->session->userdata('role') == 3){ echo ' disabled';} ?>>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
										...
										if(isset($slideInfo->oneliner)) {
											echo $slideInfo->oneliner;
										}  ?>" id="oneliner" name="oneliner" maxlength="555">
                                    </div>
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageOneliner">Back</a>
                                        </div>
                                    </div>
                                </div>
                             </div>
