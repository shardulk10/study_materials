                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo[0]->menu_name)) {echo ($slideInfo[0]->menu_name);}  ?>" id="menu_name" name="menu_name" maxlength="128">
                                    </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_keyword" name="meta_keyword"><?php if(isset($slideInfo[0]->meta_keywords)) {echo $slideInfo[0]->meta_keywords;}  ?></textarea>
                                    </div>
                                </div>
                               </div>
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_description" name="meta_description"><?php if(isset($slideInfo[0]->meta_description)) {echo $slideInfo[0]->meta_description;}  ?></textarea>
                                    </div>
                                </div>
                               </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="mainpage" id="mainpage" value="1" <?php if(!empty($slideInfo[0]->mainpage)){ echo "checked";} ?>>
