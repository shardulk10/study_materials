<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Static page
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="row">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>addNewStaticpage" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="page_type" name="page_type" required>
                                            ...
                                            ?>
                                            <option value="<?php echo $k ?>"><?php echo $cube ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('profile_name') ?>" id="profile_name" name="profile_name" maxlength="128" required>
                                    </div>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('slug') ?>" id="slug" name="slug" maxlength="128" required>
                                    </div>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">Menu Name</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('menu_name') ?>" id="menu_name" name="menu_name" maxlength="128">
                                    </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="description" name="description" required><?php echo set_value('description') ?></textarea>
                                    </div>
                                </div>
                               </div>
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo set_value('meta_title') ?>" id="meta_title" name="meta_title">
                                    </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_keyword" name="meta_keyword"><?php echo set_value('meta_keyword') ?></textarea>
                                    </div>
                                </div>
                               </div>
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="meta_description" name="meta_description"><?php echo set_value('meta_description') ?></textarea>
                                    </div>
                                </div>
                               </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="email">Main Page</label>
                                        <input type="checkbox" name="mainpage" id="mainpage" value="1">
