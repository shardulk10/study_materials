            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>addNewUser" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
							...
							<?php /*<div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="website" name="website">
                                            <option value="">Website</option>
                                            <?php
                                            if(!empty($websites))
                                            {
                                                foreach ($websites as $key=>$st)
                                                {
                                                    ?>
                                                    <option value="<?php echo $st->siteId ?>" <?php if($st->siteId == set_value('siteId')) {echo "selected=selected";} ?>><?php echo $st->site_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
