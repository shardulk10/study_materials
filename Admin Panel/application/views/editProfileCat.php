<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Profile Category
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateProfileCat/<?php echo $slideInfo->id ?>" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->cat_name)) {echo ($slideInfo->cat_name);}  ?>" id="profile_name" name="profile_name" maxlength="128">
                                    </div>
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageProfileCat">Back</a>
                                        </div>
                                    </div>
                                </div> 
                             </div>   
