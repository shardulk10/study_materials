...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Faqs
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateFaqs/<?php echo $slideInfo->id ?>" method="post" role="form" <?php if($this->session->userdata('role') == 3){ echo ' disabled';} ?>>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
										...
										if(isset($slideInfo->question)) {
											echo $slideInfo->question;
										}  ?>" id="question" name="question" maxlength="255">
                                    </div>
                              ...
                              <div class="row">  
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="20" rows="5" class="form-control" id="answer" name="answer">
                                            <?php if(isset($slideInfo->answer)) {echo nl2br($slideInfo->answer);}  ?>
                                        </textarea>
                                    </div>
                                </div>
                               </div> 
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageFaqs">Back</a>
                                        </div>
                                    </div>
                                </div> 
                             </div>   
