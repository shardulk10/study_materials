...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Email
        <small>Add / Edit Email</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateEmailsubscription/<?php echo $slideInfo->id ?>" method="post" role="form" <?php if($this->session->userdata('role') == 3){ echo ' disabled';} ?>>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">Oneliner</label>
                                        <input type="text" class="form-control required" value="<?php
										if(isset($slideInfo->email)) {
											echo $slideInfo->email;
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="subscribed" id="subscribed" value="1" <?php if(!empty($slideInfo->subscribed)){ echo "checked";} ?>>
