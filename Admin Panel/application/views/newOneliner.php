<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Oneliner
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>addNewOneliner" method="post" role="form" <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">Oneliner</label>
                                        <input type="text" class="form-control required" value="" id="oneliner" name="oneliner" maxlength="255">
                                    </div>
                                </div>
                              </div>
