<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Accordian Image
        <small>Add / Edit Accordian Image</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Accordian Image Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>updateAccordianImage/<?php echo $slideInfo->id ?>" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                               ...
                               <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($slideInfo->image_order)) {echo ($slideInfo->image_order);}  ?>" id="image_order" name="image_order" maxlength="128">
                                    </div>
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageHPSlider">Back</a>
                                        </div>
                                    </div>
                                </div> 
                             </div>   
