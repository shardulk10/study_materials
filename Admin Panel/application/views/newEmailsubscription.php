<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Email Subscription
        <small>Add / Edit Email Subscription</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Email Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>addNewEmailsubscription" method="post" role="form" <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">Email</label>
                                        <input type="text" class="form-control required" value="" id="email" name="email" maxlength="255">
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="email">Subscribed</label>
                                        <input type="checkbox" name="subscribed" id="subscribed" value="1" <?php if(!empty($slideInfo[0]->subscribed)){ echo "checked";} ?>>
                            ...
                            <div class="col-md-5">
                                    <div class="form-group">
                                       <div class="box-footer" style="margin-top: 12px;">
                                            ...
                                            <a class="btn btn-default" href="<?php echo base_url() ?>manageEmailsubscription">Back</a>
                                        </div>
                                    </div>
                                </div>
                             </div>
