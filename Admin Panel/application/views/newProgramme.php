...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Programme
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add Prgramme Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addSlide" action="<?php echo base_url() ?>addNewProgramme" method="post" role="form" enctype='multipart/form-data' <?php if($this->session->userdata("role")== 3){ echo 'onSubmit="return false";';} ?>>
                        <div class="box-body">
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="cat_id" name="cat_id" required>
                                            ...
                                            if($cube->id == $slideInfo->programme_category) {echo "selected=selected";} ?>><?php echo $cube->cat_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="faculty_id[]" name="faculty_id[]" multiple required>
                                            ...
                                            if($faculty->id == $slideInfo->programme_category) {echo "selected=selected";} ?>><?php echo $faculty->profile_name ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
